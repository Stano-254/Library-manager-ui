<template>
  <card>
    <h4 slot="header" class="card-title">Add Author Details</h4>
    <form class="justify-content-center">
      ...
      <div class="text-center">
        <base-button  type="submit"
          class="mx-1 btn-info btn-fill float-right"@click="addAuthor()">Add Author</base-button>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      addAuthor () {
        ...
        apiClient.post('books/create_author/',this.author)
        .then(response => {
