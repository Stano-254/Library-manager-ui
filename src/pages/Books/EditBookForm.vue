<template>
  ...
  <card >
    <h4 slot="header" class="card-title">Edit Book</h4>
    <form class="justify-content-center px-5">
      ...
      <div class="row justify-content-between">
        <div class="col-md-5 my-2">
          <base-input type="text"
                    ...
                    v-model="book.isbn" aria-disabled="true" disabled="true">
          </base-input>
        </div>
        <div class="col-md-6">
          <div class="row m-0">
      ...
      <div class="text-center mx-5">
        ...
        class="mx-1 btn-info btn-fill float-right"@click="updateBook()">update Book</base-button>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      this.book.author = this.book.author_id
      this.book.category = this.book.category_id
      this.get_authors()
      this.fetchCategory()
    },
    ...
    methods: {
      ...
      updateBook () {
        ...
        const data={
          ...
          id:this.book.id,
          no_of_books:this.book.no_of_books,
          published_date:this.book.published_date,
        }
        
        apiClient.post('books/update_book/',data)
      .then(response => {
